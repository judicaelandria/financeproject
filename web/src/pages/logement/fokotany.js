...
import FokotanyModal from "../../components/modal/FokotanyModal";
...
const Fokotany = () => {
  ...
  const { data, error, isLoading } = useQuery("fokotany", async () => {
            ...
            <Tbody>
              ...
              {data &&
                ...
                data.map((info) => (
                  <Tr key={info._id}>
                    <Td>{info.nom}</Td>
                    <Td>{info.commune.nom}</Td>
                    {user && user.isAdmin && (
                      <Td>
                        <Tooltip label="Mettre à jour la commune">
                          <EditIcon
                            cursor="pointer"
                            color="green.600"
                            width="1.3em"
